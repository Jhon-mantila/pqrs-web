            ...
            <ul class=""><!-- //////////////////INICIO UL DE NAVGCION//////////////////// -->
                <li class="linea">
                    ...
                    <li class="sub-menu linea">
                        ...
                        <ul>
                            <li class="nav-item"><a class="nav-link" href="ingresarUsuarios.php">Operarios</a></li>
                   ...
                   <li class="sub-menu linea">
                        ...
                        <ul>
                            <li class="nav-item"><a class="nav-link" href="consultaPeticiones.php">Consultar por Peticiones</a></li>
