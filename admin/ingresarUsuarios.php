            ...
            <form action="insert/insertarUsuarios.php" method="post" id="formUsuario">
               ...
               <div class="row gy-5">
                    <div class="col-sm">
	                    ...
	                    <?php 
	                      include ('../config/conexion1.php');
	                      $consulta = mysqli_query($con, "SELECT ID_R, ROL FROM ROL WHERE ID_R=2");
	                        while ($valores = mysqli_fetch_row($consulta)){            
	                        echo '<option  value="'.$valores[0].'" >'.$valores[1].'</option>';
                    ...
                    <div class="col-sm">
	                    ...
	                    <?php 
	                      include ('../config/conexion1.php');
	                      $consulta = mysqli_query($con, "SELECT ID_EMP,NOM_EMPRESA FROM empresa WHERE ACTIVO=1");
	                        while ($valores = mysqli_fetch_row($consulta)){            
	                        echo '<option  value="'.$valores[0].'" >'.$valores[1].'</option>';
